 ...
 */
  ...
  //|----+----+----+----+----+----+----|                                                         |----+----+----+----+----+----+----|
     /** KC_LSPO **/  TD(SPL_O),  DE_Y  , DE_X  , DE_C  , DE_V  , DE_B  ,KC_PGUP,                                      LT(_SYMB, KC_END) , DE_N  , DE_M  , DE_COMM, DE_DOT , DE_MINS , /** KC_RSPC **/ TD(SPL_C),
  //|----+----+----+----+----+----+----|                                                         |----+----+----+----+----+----+----|
     KC_LGUI , DE_LESS , DE_HASH , LALT_T(KC_KP_PLUS),LCTL_T(KC_KP_ASTERISK),CTL_T(KC_BSPC) , ALT_T(KC_DEL) ,                    CTL_T(KC_ENT) , ALGR_T(KC_SPC), DE_ALGR , KC_LEFT, KC_DOWN, KC_UP , KC_RGHT
  //`----+----+----+----+----+----+----'                                                         `----+----+----+----+----+----+----'
  ),
