 ...
 */
  ...
  [_SYMB] = LAYOUT(
    ...
    _______, DE_EXLM, DE_AT ,  DE_LCBR, DE_RCBR, DE_PIPE, _______,                             _______, DE_0   ,  DE_1   , DE_2, DE_3   , XXXXXXX, KC_F12,
    _______, DE_HASH, DE_DLR , DE_LBRC, DE_RBRC, DE_TILD,  _______,                            _______, DE_PLUS,  DE_4   , DE_5, DE_6   , XXXXXXX, XXXXXXX,
    _______, DE_PERC, DE_CIRC, DE_LPRN, DE_RPRN, DE_ACUT, _______,                             _______, KC_PDOT,  DE_7   , DE_8, DE_9   , XXXXXXX, _______,
    _______, _______, _______, KC_LALT, KC_LCTL, _______, _______,                             _______, _______,  _______, XXXXXXX, KC_PDOT, XXXXXXX, XXXXXXX
  ),
